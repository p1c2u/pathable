...
class TestPathAccessorStat:
    ...
    @pytest.mark.skipif(sys.version_info < (3, 10), reason="follow_symlinks requires Python 3.10+")
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="lstat used on Python < 3.10")
